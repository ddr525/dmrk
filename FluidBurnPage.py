    ...
    def __init__(self, master, root, database, **kwargs):
        ...
        if(self.database.get_experiment_number() != 0):
            ...
            data = [
                ...
                ("Цена смешанного газа, тг", toFixed(71.67, 1)),
                ...
                ["Теплоёмкость дыма, кДж/(м³·К)", toFixed(1624, 3)],
                ["Калориметрическая температура горения, °C", toFixed(1997, 3)],
                ["Действительная температура горения, °C", toFixed(1250, 3)],
            ]
